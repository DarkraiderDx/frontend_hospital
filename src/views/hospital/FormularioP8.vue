<template>
    <div class="card">
        ...
        <h2>PRODUCCION DE EXAMENES COMPLEMENTARIOS P-8 PACIENTES PARTICULARES</h2>
...
import FormularioP8Service from '../../service/FormularioP8Service';
...
export default {
    ...
    setup() {
        ...
        const fetchData = async () => {
            loading.value = true;
            try {
                const response = await FormularioP8Service.filterData(
