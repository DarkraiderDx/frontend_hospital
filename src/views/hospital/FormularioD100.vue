<template>
    <div class="card">
        ...
        <h2>PRODUCCION DE PROCEDIMIENTOS D-100 PACIENTES SUS</h2>
        <div class="contendor-filtro-kpi">
            <div class="Kpi_hospital">
                <div class="kpi_general">
                    <h5>TOTAL PROCEDIMIENTOS REALIZADOS</h5>
...
import FormularioD100Service from '../../service/FormularioD100Service';
...
export default {
    ...
    setup() {
        ...
        const fetchData = async () => {
            loading.value = true;
            try {
                const response = await FormularioD100Service.filterData(
